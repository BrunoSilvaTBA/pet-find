    ...
    <div class="content">
        ...
        <div class="content-middle">
            ...
            <div class="col-md-6 content-middle2">
                <h3>Sobre</h3>
                <p>A “NetPet Soluções Informatizadas” iniciou suas atividades no dia 9 de agosto de 2018, na cidade de Nova Iguaçu, Rio de Janeiro. Essa empresa tem como missão providenciar soluções informatizadas voltadas principalmente para o ramo dos pets, mas também providencia auxilio tecnológico para outras empresas que atuem na cidade do Rio de Janeiro e nas proximidades da Baixada Fluminense. A empresa é conhecida por suas abordagens criativas e de grande utilização de técnicas visuais que ajudam o usuário a não se perder no programa que estará utilizando e também fugindo do atual paradigma de design.</p>
                <p>A Empresa provê Soluções Informatizadas para qualquer tipo de negócio, mas voltada especificamente para o ramo dos pets e bichos de estimação, desde aplicações de desktop para o ramo de vendas, saúde, adestramento e outros, até aplicativos o âmbito de Smartphones.</p>
